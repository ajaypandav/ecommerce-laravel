...
@section('content')
    <!-- Page Content -->
    <div class="content">
        <h2 class="content-heading pt-0">Banner</h2>
            ...
            <div class="block-header block-header-default d-block">
                <div class="row">
                	<div class="col" align="right">
                		<a href="{{ url('admin/banner/create') }}" class="btn btn-outline-primary"><i class="fa fa-plus mr-5"></i> Add New</a>
                	</div>
                </div>
            </div>
