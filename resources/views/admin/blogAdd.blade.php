    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-content">
                <form class="js-validation-bootstrap" method="post" action="{{ route('blog.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="author" name="author" placeholder="Enter author" required="" value="{{ old('author') }}">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="form-group">
                                ...
                                <textarea name="short_description" id="short_description" class="form-control" maxlength="255" placeholder="Enter short description">{{ old('short_description') }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" class="js-summernote" required="">{{ old('description') }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="js-tags-input form-control" data-height="34px" id="tags" name="tags" value="{{ old('tags') }}">
                                @if ($errors->has('tags'))
